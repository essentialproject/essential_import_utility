 ...
 *
 */
public class InstanceSlotScript extends InstanceSlot implements SlotImportSpecData {

	public static String TEMPLATE_NAME = "Instance Slot";
	private String parentInstanceVar;
	private String parentClassName;
	
	
	public InstanceSlotScript() {
		super();
	}
	
	public InstanceSlotScript(InstanceSlot instanceSlot) {
		super();
	 ...
	 */
	public InstanceSlotScript getCopy() {
		return new InstanceSlotScript(this);
	}
