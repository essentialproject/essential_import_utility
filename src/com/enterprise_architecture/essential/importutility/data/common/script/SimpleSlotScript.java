 ...
 *
 */
public class SimpleSlotScript extends SimpleSlot implements SlotImportSpecData {
	
	public static String TEMPLATE_NAME = "Simple Text Slot";
	private String parentInstanceVar;
	private String parentClassName;
	
	
	public SimpleSlotScript() {
		super();
	}
	
	public SimpleSlotScript(SimpleSlot aSimpleSlot) {
		super();
		this.slotName = aSimpleSlot.getSlotName();
		this.sequenceNo = aSimpleSlot.getSequenceNo();
		this.slotValueRef = aSimpleSlot.getSlotValueRef();
	}
	...
	/**
	 * @return SimpleSlotScript a copy of this SimpleSlotScript
	 */
	public SimpleSlotScript getCopy() {
		return new SimpleSlotScript(this);
	}
	...
	public List<ImportSpecData> validate(List<ImportSpecData> invalidData) {
		// TODO Auto-generated method stub
		if((this.getSlotName() == null) || (this.getSlotValueRef() == null)) {
	...
	public String toString() {
		// TODO Auto-generated method stub
		String myString = "Simple Text Slot: ";
	...
	public boolean isValid() {
		// TODO Auto-generated method stub
		if((this.getSlotName() == null) || (this.getSlotValueRef() == null) || (this.getParentInstanceVariable() == null)) {
			return false;
		}
		return true;
	}
