 ...
 *
 */
public class InstanceSlotEditorComposer extends EssentialImportInterface {

	private ImportSpecDataManager importSpecDataManager;
	
	public Div instanceSlotEditorDiv;
	...
	private InstanceSlotScript currentInstanceSlot;
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		IdSpace window = instanceSlotEditorDiv.getSpaceOwner();
        ...
        if(!currentData.getClass().getName().endsWith("InstanceSlotScript")) {
        	importspectree.setModel(importspectree.getModel());
        	return;
        }
		this.currentInstanceSlot = (InstanceSlotScript) currentData;
