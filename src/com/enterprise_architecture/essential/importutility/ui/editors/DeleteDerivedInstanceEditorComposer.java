 ...
 *
 */
public class DeleteDerivedInstanceEditorComposer extends EssentialImportInterface {

	private DeleteDerivedInstanceTypeScript currentInstance;
	...
	public Div deleteDerivedInstanceDiv;
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		IdSpace window = deleteDerivedInstanceDiv.getSpaceOwner();
        ...
        // 06.09.2018 JWC - Removed south panel
        ...
        if(!currentData.getClass().getName().endsWith("DeleteDerivedInstanceTypeScript")) {
        	importspectree.setModel(importspectree.getModel());
        	return;
        }
		this.currentInstance = (DeleteDerivedInstanceTypeScript) currentData;
	...
	private void updateDerivedValueList(Listbox aListbox, DerivedValue derivedValue) {
		...
		public void initNameValueSegmentList(String className) {
			...
			if(className != null) {
				...
				final String newClassName = className;
				final DerivedValue valueTemplate = this.appDataManager.getValueTemplateForSlot(className, nameSlotName);
