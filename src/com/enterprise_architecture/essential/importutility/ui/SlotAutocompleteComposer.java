...
/**
 * This class used to support autocomplete of combo boxes used to select Essential Slots
 * 
 * @author Joson Powell <jason.powell@e-asolutions.com>
 * @version 1.0 - 28.06.2011
 *
 */
public class SlotAutocompleteComposer extends EssentialImportInterface {
	...
	List<String> getSlotNames() { //return all items
