 ...
 *
 */
public class DeleteSimpleInstanceTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public DeleteSimpleInstanceTreeNode(Object data, boolean open) {
        super(data);
        this.setOpen(open);
    }

    
    public DeleteSimpleInstanceTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public DeleteSimpleInstanceTreeNode	(Object data, List children) {
        super(data, children);
    }
 
    public DeleteSimpleInstanceTreeNode(Object data) {
