 ...
 *
 */
public class DeleteAllInstanceSlotTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public DeleteAllInstanceSlotTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public DeleteAllInstanceSlotTreeNode(Object data, List children) {
        super(data, children);
    }
 
    public DeleteAllInstanceSlotTreeNode(Object data) {
