 ...
 *
 */
public class GlobalInstanceTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public GlobalInstanceTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public GlobalInstanceTreeNode(Object data, List children) {
        super(data, children);
    }
 
    public GlobalInstanceTreeNode(Object data) {
