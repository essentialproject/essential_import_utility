 ...
 *
 */
public class DeleteInstanceSlotTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public DeleteInstanceSlotTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public DeleteInstanceSlotTreeNode(Object data, List children) {
        super(data, children);
    }
 
    public DeleteInstanceSlotTreeNode(Object data) {
