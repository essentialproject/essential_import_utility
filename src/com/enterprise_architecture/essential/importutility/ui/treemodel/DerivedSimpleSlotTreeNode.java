 ...
 *
 */
public class DerivedSimpleSlotTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public DerivedSimpleSlotTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public DerivedSimpleSlotTreeNode(Object data, List children) {
        super(data, children);
    }
 
    public DerivedSimpleSlotTreeNode(Object data) {
