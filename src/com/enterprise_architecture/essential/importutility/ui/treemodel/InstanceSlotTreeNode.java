 ...
 *
 */
public class InstanceSlotTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public InstanceSlotTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public InstanceSlotTreeNode(Object data, List children) {
        super(data, children);
    }
 
    public InstanceSlotTreeNode(Object data) {
