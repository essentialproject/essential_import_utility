 ...
 *
 */
public class RemoveInstanceSlotTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public RemoveInstanceSlotTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public RemoveInstanceSlotTreeNode(Object data, List children) {
        super(data, children);
    }
 
    public RemoveInstanceSlotTreeNode(Object data) {
