 ...
 *
 */
public class RemoveInstanceSlotScript extends RemoveInstanceSlot implements SlotImportSpecData {

	public static String TEMPLATE_NAME = "Remove Instance Slot";
	private String parentInstanceVar;
	private String parentClassName;
	
	
	public RemoveInstanceSlotScript() {
		super();
	}
	
	public RemoveInstanceSlotScript(RemoveInstanceSlot instanceSlot) {
		super();
	 ...
	 */
	public RemoveInstanceSlotScript getCopy() {
		return new RemoveInstanceSlotScript(this);
	}
	...
	public String toString() {
		// TODO Auto-generated method stub
		String myString = "Remove Instance Slot: ";
