 ...
 *
 */
public class RemoveAllInstanceSlotScript extends RemoveAllInstanceSlot implements SlotImportSpecData {

	public static String TEMPLATE_NAME = "Remove All Slot Values";
	private String parentInstanceVar;
	private String parentClassName;
	
	
	public RemoveAllInstanceSlotScript() {
		super();
	}
	
	public RemoveAllInstanceSlotScript(RemoveAllInstanceSlot instanceSlot) {
		super();
	 ...
	 */
	public RemoveAllInstanceSlotScript getCopy() {
		return new RemoveAllInstanceSlotScript(this);
	}
	...
	public String toString() {
		// TODO Auto-generated method stub
		String myString = "Remove All Instance Slot: ";
		if(this.getSlotName() != null) {
