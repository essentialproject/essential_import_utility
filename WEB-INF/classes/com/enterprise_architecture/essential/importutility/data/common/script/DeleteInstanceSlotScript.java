 ...
 *
 */
public class DeleteInstanceSlotScript extends DeleteInstanceSlot implements SlotImportSpecData {

	public static String TEMPLATE_NAME = "Delete Instance Slot";
	private String parentInstanceVar;
	private String parentClassName;
	
	
	public DeleteInstanceSlotScript() {
		super();
	}
	
	public DeleteInstanceSlotScript(DeleteInstanceSlot instanceSlot) {
		super();
		...
		this.instanceSlotVar = instanceSlot.getInstanceSlotVar();
	}
	...
	public static HashMap<String, String> getScriptTokens() {
		...
		myTokens.put("Instance Slot Variable", ImportSpecDataManager.INSTANCE_SLOT_VARIABLE_TOKEN);
		return myTokens;
	}
	 ...
	 */
	public DeleteInstanceSlotScript getCopy() {
		return new DeleteInstanceSlotScript(this);
	}
	...
	public List<ImportSpecData> validate(List<ImportSpecData> invalidData) {
		// TODO Auto-generated method stub
		if((this.getSlotName() == null) || (this.getInstanceSlotVar() == null)) {
	...
	public String toString() {
		// TODO Auto-generated method stub
		String myString = "Delete Instance Slot: ";
		if(this.getSlotName() != null) {
			myString = myString + this.getSlotName();
		} else {
			myString = myString + "<UNDEFINED>";
		}
		if(this.getInstanceSlotVar() != null) {
			myString = myString + " (" + this.getInstanceSlotVar() + ")";
		}
		return myString;
	}
	...
	public boolean isValid() {
		// TODO Auto-generated method stub
		if((this.getSlotName() == null) || (this.getInstanceSlotVar() == null) || (this.getParentInstanceVariable() == null)) {
			return false;
		}
		return true;
	}
	...
	public String printImportScript(String srcRepositoryName, Spreadsheet spreadsheet, HashMap<String, HashMap<String, String>> scriptTemplateMap, String currentRow) {
		if(!this.isValid()) {
			...
			//update the template with this instance slot's variable name
			importScriptString = importScriptString.replace(ImportSpecDataManager.INSTANCE_SLOT_VARIABLE_TOKEN, this.instanceSlotVar);
