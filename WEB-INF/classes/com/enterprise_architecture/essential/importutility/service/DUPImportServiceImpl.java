...
/**
 * Class to implement the DUP service. Using the controller pattern, validates the request parameters
 ...
 *
 */
public class DUPImportServiceImpl 
{
	/**
								...
								String theTenantUserSsoToken)
	{
		...
		DUPImportJob anImportJob = new DUPImportJob();
