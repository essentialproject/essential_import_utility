 ...
 * 23.08.2018	JWC Remove ZK ZSS - Migrate to ZK 8.5
 * 
 */
 ...
 *
 */
public class DeleteAllInstanceSlotEditorComposer extends EssentialImportInterface {

	private ImportSpecDataManager importSpecDataManager;
	
	public Div deleteAllInstanceSlotEditorDiv;
	...
	private DeleteAllInstanceSlotScript currentInstanceSlot;
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		IdSpace window = deleteAllInstanceSlotEditorDiv.getSpaceOwner();
        ...
        if(!currentData.getClass().getName().endsWith("DeleteAllInstanceSlotScript")) {
        	importspectree.setModel(importspectree.getModel());
        	return;
        }
		this.currentInstanceSlot = (DeleteAllInstanceSlotScript) currentData;
