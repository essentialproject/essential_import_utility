 ...
 *
 */
public class DeleteInstanceSlotEditorComposer extends EssentialImportInterface {

	private ImportSpecDataManager importSpecDataManager;
	
	public Div deleteInstanceSlotEditorDiv;
	...
	private DeleteInstanceSlotScript currentInstanceSlot;
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		IdSpace window = deleteInstanceSlotEditorDiv.getSpaceOwner();
        ...
        if(!currentData.getClass().getName().endsWith("DeleteInstanceSlotScript")) {
        	importspectree.setModel(importspectree.getModel());
        	return;
        }
		this.currentInstanceSlot = (DeleteInstanceSlotScript) currentData;
