 ...
 *
 */
public class SimpleSlotTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public SimpleSlotTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public SimpleSlotTreeNode(Object data, List children) {
        super(data, children);
    }
 
    public SimpleSlotTreeNode(Object data) {
