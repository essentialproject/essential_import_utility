 ...
 *
 */
public class DeleteDerivedInstanceTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public DeleteDerivedInstanceTreeNode(Object data, boolean open) {
        super(data);
        this.setOpen(open);
    }
    
    public DeleteDerivedInstanceTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public DeleteDerivedInstanceTreeNode(Object data, List children) {
        super(data, children);
    }

 
    public DeleteDerivedInstanceTreeNode(Object data) {
