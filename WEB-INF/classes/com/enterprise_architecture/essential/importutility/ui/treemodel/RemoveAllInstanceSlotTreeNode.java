 ...
 *
 */
public class RemoveAllInstanceSlotTreeNode extends DefaultTreeNode {
	// Node Control the default open
    private boolean open = false;
 
    public RemoveAllInstanceSlotTreeNode(Object data, List children, boolean open) {
        super(data, children);
        this.setOpen(open);
    }
 
    public RemoveAllInstanceSlotTreeNode(Object data, List children) {
        super(data, children);
    }
 
    public RemoveAllInstanceSlotTreeNode(Object data) {
