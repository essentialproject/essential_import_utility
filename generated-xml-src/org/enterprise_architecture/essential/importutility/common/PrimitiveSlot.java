 ...
 *         &lt;element ref="{http://www.enterprise-architecture.org/essential/importutility/common}PrimitiveSlotType"/>
...
@XmlRootElement(name = "PrimitiveSlot")
public class PrimitiveSlot {

    @XmlElement(name = "SlotName", required = true)
    protected String slotName;
    @XmlElement(name = "SlotValueRef", required = true)
    protected String slotValueRef;
    @XmlElement(name = "PrimitiveSlotType", required = true)
    protected String primitiveSlotType;
    ...
    /**
     * Gets the value of the primitiveSlotType property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPrimitiveSlotType() {
        return primitiveSlotType;
    }

    /**
     * Sets the value of the primitiveSlotType property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPrimitiveSlotType(String value) {
        this.primitiveSlotType = value;
    }
